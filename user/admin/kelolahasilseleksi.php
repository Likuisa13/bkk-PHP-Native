...
<html lang="en">
    ...
    ?>
        ...
        <script>
            ...
            function showModalEdt(id,kd,tgl,des) {
                $('#idhasil').val(id);
                $('#lowongan').val(kd);
                $('#tgl').val(tgl);
                $('#deskripsi').val(des);
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="kelolahasilseleksi.php">Data Hasil seleksi</a></li>
            ...
            <section id="intro" class="intro">
                <div class="intro-content">
                    <div class="container">
                        <h4><center><b>DATA HASIL SELEKSI</b></center></h4>
                            <div class="col-lg-12">
                                    ...
                                    <div class="wow" data-wow-duration="2s" data-wow-delay="0.2s">
                                        <div class="row" >
                                                    <div class="col-lg-9">
                                                        ...
                                                        <a href="printhasilseleksi.php"><button type="button" class="btn btn-warning">
                                                            <i class="fa fa-print"></i> Print
                                                        </button></a>
                                                        <a href="excelhasilseleksi.php"><button type="button" class="btn btn-info">
                                                    ...
                                                    <tbody id="userlist">
                                                        ...
                                                        foreach ($result as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="<?php echo $value['url'] ?>"><?php echo $value['file'] ?></a></td>
                                                                <td nowrap>
                                                                    <button type="button" onclick="showModalEdt(<?php echo $value['id_hasil']?>
                                                                    ,'<?php echo $value['id_lowongan']?>','<?php echo $value['tgl_tutup']?>'
                                                                    ,'<?php echo $value['deskripsi']?>')" class="btn btn-primary btn-sm">
                                                                        <i class="fa fa-paint-brush"></i> Edit
                                                                    </button>
                                                                    <button type="button" onclick="showModalDel(<?php echo $value['id_hasil']; ?>,'<?php echo $value['nama_perusahaan']; ?>');" class="btn btn-danger btn-sm">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="ModalLabel01"><center>
                                Data Hasil Seleksi</center>
                            </h5>
                        </div>
                        <div class="modal-body" style="padding:40px 50px;">
                          <form role="form" method="post" action="executehasil.php" enctype = "multipart/form-data">
                            <div class="row">
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                  <label><span class="fa fa-calendar"></span> Tgl Tutup</label>
                                  <input type="date" class="form-control" name="tgl" id="tgl" placeholder="No. Telepon">
                                </div>
                            </div>
                            </div>
                            <div class="row">
                            <div class="col col-md-12">
                                <div class="form-group">
                                  <label><span class="fa fa-newspaper-o"></span> Deskripsi</label>
                                  <textarea rows="10" class="form-control" name="deskripsi" id="deskripsi" placeholder="Deskripsi"></textarea>
                                </div>
                            </div>    
                            </div>
                            <div class="row">
                            <div class="col col-md-12">
                                <div class="form-group">
                                  <label><span class="fa fa-upload"></span> Upload File</label>
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-success" type="submit" name="addfile">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-danger">
                            ...
                            <h5 class="modal-title" id="ModalLabel01"><center>
                                Delete Data Hasil seleksi</center>
                            </h5>
                        </div>
                        <div class="modal-body">
                            ...
                            <form role="form" method="post" action="executehasil.php">
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            <input type="hidden" name="idhasil" id="iddel">
                                            <input type="hidden" name="proc" id="proc" value="">
                                        </div>                                    
                                    </div>
                                </div> 
