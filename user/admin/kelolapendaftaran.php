...
<html lang="en">
    ...
    ?>
        ...
        <script>
            ...
            function showModalEdt(id,low,can,tgl,sts) {
                $('#idku').val(id);
                $('#lowonganku').val(low);
                $('#canaker').val(can);
                $('#tgl').val(tgl);
        ...
        $dao = new Dao();
        $cari = '';
        $result = $dao->readPendaftaran($_SESSION['id_lowongan']);
        ?>
    </head>
        ...
        <div id="wrapper">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="kelolapendaftaran.php">Data Pendaftaran</a></li>
            ...
            <section id="intro" class="intro">
                <div class="intro-content">
                    <div class="container">
                        <h4><center><b>DATA PENDAFTARAN</b></center></h4>
                            <div class="col-lg-12">
                                    ...
                                    <div class="wow" data-wow-duration="2s" data-wow-delay="0.2s">
                                        <div class="row" >
                                                    <div class="col-lg-9">
                                                        ...
                                                        <a href="printpendaftaran.php"><button type="button" class="btn btn-warning">
                                                            <i class="fa fa-print"></i> Print
                                                        </button></a>
                                                        <a href="excelpendaftaran.php"><button type="button" class="btn btn-info">
                                        ...
                                        <br>
                                        <form role="form" method="post" action="executependaftaran.php">
                                        <div class="row">
                                            <div class="col-md-5">
                                            <div class="input-group">
                                                <input type="hidden" name="proc" value="show">
                                                <select class="form-control" name="lowongan" id="lowongan">
                                                <option><?php echo $_SESSION['perusahaan']," - ",$_SESSION['posisi']," - ",$_SESSION['tglbuka'] ?></option>
                                                <?php
                                                $lowongan = $dao->readDataLowongan();
                                                $i = 1;
                                                foreach ($lowongan as $value) {
                                                  ?>
                                                    $tgl = $value['tgl_buka'];
                                                    $tgl_buka = date("d M Y", strtotime($tgl)); 
                                                    <option value="<?php echo $value['id_lowongan']?>"><?php echo $value['nama_perusahaan']," - ",$value['posisi']," - ",$value['tgl_buka'] ?></option>
                                                  <?php
                                                  $i++;
                                                  }
                                                ?>
                                                ...
                                                <div class="input-group-btn">
                                                    <button class="btn btn-info" type="submit" method="post"><i class="fa fa-play"></i> Show</button>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <tbody id="userlist">
                                                        ...
                                                        foreach ($result as $value) {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td nowrap>
                                                                    <button type="button" onclick="showModalEdt(<?php echo $value['id_pendaftaran']; ?>
                                                                    ,'<?php echo $value['id_lowongan']; ?>','<?php echo $value['id_canaker']; ?>'
                                                                    ,'<?php echo $value['tgl_buka']; ?>','<?php echo $value['status_pembayaran']; ?>');" class="btn btn-primary btn-sm">
                                                                        <i class="fa fa-paint-brush"></i> Edit
                                                                    </button>
                                                                    <button type="button" onclick="showModalDel(<?php echo $value['id_pendaftaran']; ?>,'<?php echo $value['nama_lengkap']; ?>');" class="btn btn-danger btn-sm">
                          ...
                          <form role="form" method="post" action="executependaftaran.php">
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="hidden" name="proc" id="procedure" value="">
                                  <label><span class="fa fa-suitcase"></span> Lowongan</label>
                                  <select class="form-control" name="lowonganku" id="lowonganku">
                                    <?php
                                    $lowongan = $dao->readDataLowongan();
                                    $i = 1;
                                    foreach ($lowongan as $value) {
                            ...
                            <div class="col col-md-6">
                                <div class="form-group">
                                  <label><span class="fa fa-user"></span> Calon Tenaga Kerja</label>
                                  <select class="form-control" name="canaker" id="canaker">
                                    <?php
                                    $lowongan = $dao->readCanaker();
                                    $i = 1;
                                    foreach ($lowongan as $value) {
                                    ?>
                                        <option value="<?php echo $value['id_canaker']?>"><?php echo $value['no_induk']," - ",$value['nama_lengkap']; ?></option>
                                    <?php
                                    $i++;
                                    }
                                    ?>    
                            ...
                            <div class="col col-md-7">
                                <div class="form-group">
                                  <label><span class="fa fa-calendar"></span> Tanggal Daftar</label>
                                  <input type="date" class="form-control" name="tgl" id="tgl">
                                </div>
                            </div>    
                                <div class="col col-md-5">
                                <div class="form-group">
                                  <label><span class="fa fa-tag"></span> Status</label>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header modal-header-danger">
                            ...
                            <h5 class="modal-title" id="ModalLabel01"><center>
                                Delete Data Pendaftaran</center>
                            </h5>
                        </div>
