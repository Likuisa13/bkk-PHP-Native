                                                    ...
                                                    ?>
                                                        <div class="panel panel-info">
                                                                ...
                                                                <div class="panel-body">
                                                                    ...
                                                                    <i class='fa fa-download'></i> <a href=" <?php echo $value['url'] ?>"><?php echo $value['file'] ?></a>
                                                            </div>
                                                        </div>
                                                        <?php 
                                                        $i++;
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 class="modal-title" style="padding:10px 30px;"><span class="glyphicon glyphicon-lock"></span> Login</h4>
                </div>
